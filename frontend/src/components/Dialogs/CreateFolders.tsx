  ...
  return (
    <div className="bg-card p-6 rounded-lg shadow-xl w-96 border border-card-foreground/20 shadow-purple-500/10">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-semibold text-card-foreground">Create Folder</h2>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          <label className="block text-sm font-medium text-card-foreground mb-2">Folder Color</label>
        ...
        <div className="mb-6">
          <label className="block text-sm font-medium text-card-foreground mb-2">Folder Icon</label>
          <div className="flex gap-3 flex-wrap">
            {icons.map((icon) => (
              <button
                key={icon.name}
